...
if (IsinCart === false) {
  ...
  <div class="d-flex flex-row shadow-sm card cart-items mt-2 mb-3 animated flipInX">
    ...
    <div class="p-2 mt-3 Dark_Fonts">
        <p class="cart_item_name Dark_Fonts">${product.name}</p>
    </div>
    <div class="p-2 mt-3 Dark_Fonts">
        <p class="cart_item_price Dark_Fonts">${product.price}</p>
    </div>
    <div class="p-2 mt-3 ml-auto Dark_Fonts">
        <button class="btn badge badge-dark" type="button" data-action="increase-item">&plus;
    </div>
    <div class="p-2 mt-3 Dark_Fonts">
      <p class="cart_item_quantity Dark_Fonts">${product.quantity}</p>
    </div>
    <div class="p-2 mt-3 Dark_Fonts">
      <button class="btn badge badge-dark" type="button" data-action="decrease-item">&minus;
    </div>
    <div class="p-2 mt-3 Dark_Fonts">
      <button class="btn badge badge-dark" type="button" data-action="remove-item">&times;
    </div>
  </div> `);

  if(document.querySelector('.cart-footer') === null){
    cartDom.insertAdjacentHTML("afterend",  `
      <div class="d-flex flex-row shadow-sm card cart-footer mt-2 mb-3 animated flipInX Dark_Fonts">
        <div class="p-2 Dark_Fonts">
          <button class="btn badge-dark" type="button" data-action="clear-cart">Clear Cart
        </div>
        <div class="p-2 ml-auto Dark_Fonts">
